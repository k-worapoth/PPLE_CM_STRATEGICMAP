...
var format_bannerMP2026_8 = new ol.format.GeoJSON();
var features_bannerMP2026_8 = format_bannerMP2026_8.readFeatures(json_bannerMP2026_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_bannerMP2026_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_bannerMP2026_8.addFeatures(features_bannerMP2026_8);
var lyr_bannerMP2026_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_bannerMP2026_8, 
                style: style_bannerMP2026_8,
                popuplayertitle: 'bannerMP2026',
                interactive: true,
                title: '<img src="styles/legend/bannerMP2026_8.png" /> bannerMP2026'
            });
...
lyr_EsriTopographic_0.setVisible(true);lyr_tambon_CMMC_1.setVisible(true);lyr_moo_faham_2.setVisible(true);lyr_moo_tambon_changpueak_3.setVisible(true);lyr_moo_suthep_4.setVisible(true);lyr_moo_sanpheseau_5.setVisible(true);lyr_moo_padet_6.setVisible(true);lyr_moo_maehia_7.setVisible(true);lyr_bannerMP2026_8.setVisible(true);
...
lyr_bannerMP2026_8.set('fieldAliases', {'id': 'id', 'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
...
lyr_bannerMP2026_8.set('fieldImages', {'id': 'TextEdit', 'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', });
...
lyr_bannerMP2026_8.set('fieldLabels', {'id': 'no label', 'Name': 'no label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_bannerMP2026_8.on('precompose', function(evt) {
